...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden tracking-tighter">
      {/* Vanta.js Background */}
      <div 
        ref={vantaRef}
      ...
      <div className="absolute inset-0 bg-white/10 backdrop-blur-[1px]" style={{ zIndex: 1 }} />
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center" style={{ zIndex: 10 }}>
